...
export default function RecommandModal({ movie }: { movie: Movie }) {
  ...
  return (
		<div className="fixed inset-x-0 bottom-0 flex justify-center animate-slide-up">
			<div className="flex flex-col max-w-[560px] min-w-[296px] mx-3 xs:mx-5 max-h-[80vh] bg-level2 rounded-t-3xl p-3 xs:p-5 gap-5 overflow-y-auto">
				<div className="grid grid-cols-1 xs:grid-cols-2">
					...
					<div className="flex flex-col items-start pt-2 pl-2 xs:pt-4 xs:pl-4 gap-1">
						...
						{movie.vote_average > 0 && (
							<span className="text-light-gray text-base font-light truncate">
				...
				<div className="flex flex-col w-full items-start justify-center">
					<span className="flex text-white text-[20px] font-light">{movie.overview}</span>
				</div>
			</div>
		</div>
